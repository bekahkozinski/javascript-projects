...
function missionDuration(numberOrbits, alt = 2000, speed = 28000) {
  ...
  console.log(`The mission will travel ${distance} km around the planet, nd it will take ${time} hours to complete.`)
  return time
}

// Copy/paste your selectRandomEntry function here:
function selectRandomEntry(arrayInput) {
  let randomIndex = Math.floor(arrayInput.length * Math.random());
