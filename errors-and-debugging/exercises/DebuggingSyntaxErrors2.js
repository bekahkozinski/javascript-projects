...
//3 &&& symbols were used as the boolean operator. this should only be &&. i have fixed this.
//there is an extra opening parantheses in the first console.log following the final if statement. i have fixed this.
